...
import './Foraminis.css';
import Header from '../components/Header/Header';
import Body from '../components/Body/Body';
import Footer from '../components/Footer/Footer';

const Foraminis = () => (
        <div id={"Foraminis"} className={"h-100 w-100 tc flex overflow-auto flex-column "}>
            <Header/>
            <Body/>
            <Footer/>
        </div>
...
export default Foraminis;
//TODO Make Log Out / Log In, Register switch display
//TODO Make Game

/*
Inspiré du combat astral contre l'esprit de Bolgrot dans le jeu Dofus d'Ankama Games.

Déroulement du jeu :

Un pion "Player"
Un nombre "thickness" de pion "Foe" invoqué aléatoirement sur le plateau par tour (pour l'instant, sûrement moins)
Un plateau de jeu de "thickness^2" cases
Une invocation est annulable si la case est déjà habitée par "Foe" ou "Player"
"Player" doit essayer de tenir le plus de tour possible en tuant le plus de "Foe" possible
"Foe" est tué lorsque "Player" se déplace sur sa case
"Player" est tué lorsque "Foe" se déplace sur sa case
La partie est terminée lorsque "Player" est tué

Tour :
Un tour est fini lorsque "Player" a utilisé toutes ses actions
"Player" a "thickness" actions
Une action est utilisée lors d'un déplacement

Mouvement :
"Player" ne peut bouger que d'une case à une autre verticalement ou horizontalement.
(Peut-être un mouvement à 2 cases coûtant 2 actions)
"Foe" se déplace de la même façon que "Player" et également en diagonale en direction de "Player"
 //Todo to end
...
Logique derrière un jeu de dames.

//Todo reverse engineering the logic behind the checkers
